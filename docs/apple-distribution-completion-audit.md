...
| Check public repository hygiene | `./scripts/check-public-repo-hygiene.sh` | Scans tracked files for high-risk secret file paths and obvious secret token patterns before public distribution. This is a local hygiene gate, not a replacement for human legal/privacy review. | Prepared |
