...
> **Repository status / Repository-Status:** Public preview. Current preview release: `v1.0.26`.
...
```text
https://github.com/MediaPublishing/token-monitor/releases/download/v1.0.26/TokenMonitor-macOS.dmg
```
