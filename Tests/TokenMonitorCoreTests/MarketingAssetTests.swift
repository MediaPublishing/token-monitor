...
struct MarketingAssetTests {
    ...
    @Test func releaseMaterialsReferenceDmgInstaller() throws {
        ...
        #expect(publicReleaseVerifier.contains("Downloading Sparkle update ZIP for local signature verification"))
        #expect(publicReleaseVerifier.contains("Downloaded Sparkle update app code signature verifies"))
        #expect(publicReleaseVerifier.contains("Downloaded Sparkle update app version matches"))
    ...
    @Test func marketingLaunchKitCoversDistributionMetadata() throws {
        ...
        #expect(launchKit.contains("Gatekeeper, stapler, and Sparkle update ZIP checks"))
        ...
        #expect(launchKit.contains("published DMG and Sparkle update ZIP"))
