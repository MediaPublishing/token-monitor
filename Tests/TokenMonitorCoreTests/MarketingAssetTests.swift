...
struct MarketingAssetTests {
    ...
    @Test func releaseMaterialsReferenceDmgInstaller() throws {
        ...
        #expect(releaseWorkflow.contains("Verify Developer ID release"))
        ...
        #expect(releaseWorkflow.contains("spctl --assess --type execute --verbose=4 dist/TokenMonitor.app"))
        #expect(releaseWorkflow.contains("xcrun stapler validate dist/TokenMonitor-macOS.dmg"))
    ...
    @Test func appleDistributionReadinessDocCoversReleasePaths() throws {
        ...
        #expect(completionAudit.contains("TOKEN_MONITOR_REQUIRE_SIGNING_SECRETS=1 ./scripts/check-github-release-secrets.sh"))
    ...
    @Test func marketingLaunchKitCoversDistributionMetadata() throws {
        ...
        #expect(launchKit.contains("./scripts/preflight-release.sh"))
